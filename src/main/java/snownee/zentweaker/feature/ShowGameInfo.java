...
//
//@KiwiModule(modid = ZenTweaker.MODID, optional = true)
//public class ShowGameInfo implements IModule
//{
//    @SubscribeEvent
...
//            player.sendStatusMessage(new TextComponentTranslation("gui.zentweaker.depth", player.world.getSeaLevel() - (int) player.posY), true);
